...
const CTAButton = ({ size = "default", className }: CTAButtonProps) => {
  ...
  return (
    <a
      ...
      className={cn(
        "inline-block bg-gradient-to-r from-green-500 to-green-400 hover:from-green-400 hover:to-green-300 text-black font-bold rounded-full transition-all duration-500 ease-out hover:scale-105 hover:shadow-lg hover:shadow-green-500/25 shadow-lg shadow-green-500/30",
