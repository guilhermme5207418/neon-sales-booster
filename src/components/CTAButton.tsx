...
const CTAButton = ({ size = "default", className }: CTAButtonProps) => {
  ...
  return (
    <a
      ...
      className={cn(
        "inline-block bg-gradient-to-r from-green-500 to-green-400 hover:from-green-400 hover:to-green-300 text-black font-bold rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-green-500/50 animate-pulse",
